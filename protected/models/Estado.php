...
class Estado extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
            ...
            array('nombre','required','message'=>'El nombre del estado no puede estar vacio.'),
            array('nombre','unique','message'=>'El nombre de ese estado ya esta registrado, por favor verifique su información.'),
		);
	}
