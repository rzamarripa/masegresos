<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<div class="clearfix">
		<?php echo $form->label($model,'proyecto_aid'); ?>
		<div class="input">
			
			<?php $this->widget('ext.custom.widgets.EJuiAutoCompleteFkField', array(
					      'model'=>$model, 
					      'attribute'=>'proyecto_aid', 
					      'sourceUrl'=>Yii::app()->createUrl('proyecto/autocompletesearch'), 
					      'showFKField'=>false,
					      'relName'=>'proyecto', // the relation name defined above
