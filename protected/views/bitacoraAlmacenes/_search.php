<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<div class="clearfix">
		<?php echo $form->label($model,'recibioUO'); ?>
		<div class="input">
			
			<?php echo $form->textField($model,'recibioUO'); ?>
		</div>
	</div>


	<div class="clearfix">
		<?php echo $form->label($model,'nombreRecibioUO'); ?>
		<div class="input">
			
			<?php echo $form->textField($model,'nombreRecibioUO',array('size'=>60,'maxlength'=>100)); ?>
		</div>
	</div>
