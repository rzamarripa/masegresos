<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<div class="clearfix">
		<?php echo $form->label($model,'numeroCotizacion'); ?>
		<div class="input">
			
			<?php echo $form->textField($model,'numeroCotizacion',array('size'=>20,'maxlength'=>20)); ?>
		</div>
	</div>
	...
	<div class="clearfix">
		...
		<div class="input">
			...
			<?php echo $form->dropDownList($model,"requisicion_did",CHtml::listData(Requisicion::model()->findAll(), 'id', 'numeroRequisicion')); ?>		</div>
	</div>
