	...
	<div class="row">
		<div class="span6">
			<div class="<?php echo 'control-group'; ?>">
				...
				<div class="controls">
					<?php
						echo $form->dropDownList($model,'proveedor_aid', CHtml::listData($proveedores, 'id', 'nombre'),
		...
		<div class="span6">
			<div class="<?php echo 'control-group'; ?>">
				...
				<div class="controls">
					<?php
						echo $form->dropDownList($model,'unidadOrganizacional_aid', CHtml::listData($uos, 'id', 'nombre'),
							array('style'=>'width:90%;','class'=>'select2minimun4')
                    );
                  ?>
	...
	<div class="row">
		<div class="span6">
			<div class="<?php echo 'control-group'; ?>">
				...
				<div class="controls">
					<?php
						echo $form->dropDownList($model,'fondo_aid', CHtml::listData($fondos, 'id', 'nombre'),
							array('style'=>'width:90%;','class'=>'select2minimun4')
                    );
                  ?>
				...
				<div class="controls">
						...
						if ($model->fechaAdquisicion_f!='')
						    ...
						    $this->widget('zii.widgets.jui.CJuiDatePicker', array(
	                                       ...
	                                       'language' => 'es',
	                                       'htmlOptions' => array('readonly'=>"", 'style'=>'width:65%', 'value' => date("Y-m-d")),
	                                      'options'=> array(
											    'dateFormat'=>'yy-mm-dd',
											    'altFormat'=>'dd-mm-yy',
											    'changeMonth'=>'true',
		...
		<div class="span4">
			<div class="<?php echo 'control-group'; ?>">
				...
				<div class="controls">
					...
					<?php
						echo $form->dropDownList($modelDetalle,'articulo_aid', CHtml::listData($articulos, 'id', 'nombre'),
							array('style'=>'width:90%;','class'=>'select2minimun2', 'ng-model' => 'detalle.articulo_aid')
                    );
                  ?>
				 <?php echo $form->error($modelDetalle,'articulo_aid'); ?>
				</div>
			</div>
		</div>
		<div class="span4">
			<div class="<?php echo 'control-group'; ?>">
				...
				<div class="controls">
					...
					<?php
						echo $form->dropDownList($modelDetalle,'unidadOrganizacional_did', CHtml::listData($uos, 'id', 'nombre'),
							array(
								'style'=>'width:90%;',
                  ...
                  ?>
				 <?php echo $form->error($modelDetalle,'unidadOrganizacional_did'); ?>
				</div>
			</div>
		</div>
		<div class="span4">
	...
	<div class="row">
		<div class="span3">
			<div class="<?php echo 'control-group'; ?>">
				...
				<div class="controls">
					<?php
	        				echo CHtml::CheckBox('chkMarca', false, array('ng-model'=>'marcas'));?>
					<?php
						echo $form->dropDownList($modelDetalle,'marca_aid', CHtml::listData($marcas, 'id', 'nombre'),
							array('style'=>'width:90%;','class'=>'select2minimun2', 'ng-model' => 'detalle.marca_aid')
                    );
                  ?>
				 <?php echo $form->error($modelDetalle,'marca_aid'); ?>
				</div>
			</div>
		</div>
		<div class="span3">
