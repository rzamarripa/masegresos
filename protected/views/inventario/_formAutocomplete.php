			...
			<div class="<?php echo 'control-group'; ?>">
				...
				<div class="controls">
					<?php $this->widget('ext.custom.widgets.EJuiAutoCompleteFkField', array(
						      ...
						      'sourceUrl'=>Yii::app()->createUrl('proveedor/autocompletesearchinventario'), 
						      'showFKField'=>false,
			...
			<div class="<?php echo 'control-group'; ?>">
				...
				<div class="controls">
						<?php $this->widget('ext.custom.widgets.EJuiAutoCompleteFkField', array(
						      ...
						      'sourceUrl'=>Yii::app()->createUrl('unidadOrganizacional/autocompletesearchinventario'), 
						      'showFKField'=>false,
			...
			<div class="<?php echo 'control-group'; ?>">
				...
				<div class="controls">
					<?php $this->widget('ext.custom.widgets.EJuiAutoCompleteFkField', array(
						      'model'=>$model, 
						      'attribute'=>'fondo_aid', 
						      'sourceUrl'=>Yii::app()->createUrl('fondo/autocompletesearchinventario'), 
						      'showFKField'=>false,
	...
	<div class="row">
		<div class="span4">
			<div class="<?php echo 'control-group'; ?>">
				...
				<div class="controls">
					<?php echo CHtml::CheckBox('chkArticulo', false, array('ng-model'=>'articulo'));?>
					<?php $this->widget('ext.custom.widgets.EJuiAutoCompleteFkField', array(
						      'model'=>$modelDetalle, 
						      'attribute'=>'articulo_aid', 
						      'sourceUrl'=>Yii::app()->createUrl('articulo/autocompletesearchinventario'), 
						      'showFKField'=>false,
		...
		<div class="span4">
			 <?php echo $form->hiddenField($modelDetalle,'unidadOrganizacional_did',array()); ?>
			<div class="<?php echo 'control-group'; ?>">
				<?php echo $form->labelEx($modelDetalle,'unidadOrganizacional_did',array('class'=>'control-label', 'ng-class'=>"{true: 'error', false: ''}[errorUo]")); ?>
				<div class="controls">
					<?php echo CHtml::CheckBox('chkUo', false, array('ng-model'=>'uo')); ?>
					<?php 
						$this->widget('zii.widgets.jui.CJuiAutoComplete', array(
					    'model'=>$modelDetalle,
					    'attribute'=>'unidadOrganizacional',
