		...
		<table class="table table-bordered table-condensed display">
			<thead class="thead">
				<tr>
					...
					<td style="text-align:center"><strong>Fecha Adq.</strong></td>
				</tr>
			</thead>
			<tbody>
				<?php foreach($inventarios as $inventario){
					if($funcionId <> $inventario['funcion_aid']){?>
						<tr>
							...
							<td colspan="6"><?php echo $inventario['funcion_nombre'];?></td>
						</tr>
					<?php $funcionId = $inventario['funcion_aid']; } ?>
				<tr>
					<td style="text-align:center"><?php echo $inventario['id'];?></td>
					<td style="text-align:center"><?php echo $inventario['nombre']?></td>
					<td style="text-align:center"><?php echo $inventario['serie'];?></td>
					<td style="text-align:center"><?php echo $inventario['modelo'];?></td>
					<td style="text-align:center"><?php echo ($inventario['lote']==1)?"Si":"No";?></td>
					<td style="text-align:center"><?php echo $inventario['cantidadPorLoteAct']?></td>
