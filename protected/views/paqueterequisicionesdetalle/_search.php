<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<div class="clearfix">
		<?php echo $form->label($model,'paqueteRequisicion_did'); ?>
		<div class="input">
			
			<?php echo $form->dropDownList($model,"paqueteRequisicion_did",CHtml::listData(PaqueteRequisicion::model()->findAll(), 'id', 'nombre')); ?>		</div>
	</div>
