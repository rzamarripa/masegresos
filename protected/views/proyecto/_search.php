<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<div class="clearfix">
		...
		<div class="input">
			...
			<?php echo $form->textField($model,'investigador',array('size'=>60,'maxlength'=>100)); ?>
		</div>
	</div>


	<div class="clearfix">
		<?php echo $form->label($model,'fechaInicio_f'); ?>
		<div class="input">
			
			<?php
					if ($model->fechaInicio_f!='') 
						$fechaInicio_f=date('d-m-Y',strtotime($fechaInicio_f));
					else
						$fechaInicio_f=date('d-m-Y');
	...
	<div class="clearfix">
		<?php echo $form->label($model,'fechaFin_f'); ?>
		<div class="input">
			
			<?php
					if ($model->fechaFin_f!='') 
						$fechaFin_f=date('d-m-Y',strtotime($fechaFin_f));
					else
						$fechaFin_f=date('d-m-Y');
					$this->widget('zii.widgets.jui.CJuiDatePicker', array(
					                                       'model'=>$model,
