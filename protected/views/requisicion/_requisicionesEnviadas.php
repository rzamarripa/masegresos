						...
						<div class="row-fluid">
							<div class="span6">
								<p class="text-center">
									...
									?>
									<?php echo CHtml::link('<span class="label label-info">Pendientes ' . $proveedoresPorRequisicion . '</span>', array('requisicion/verproveedorespendientes','id'=>$requisicion->id)); ?>
								</p>
							</div>
							<div class="span6">
								<p class="text-center">
