<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<div class="clearfix">
		<?php echo $form->label($model,'unidadOrganizacional_did'); ?>
		<div class="input">
			
			<?php echo $form->dropDownList($model,"unidadOrganizacional_did",CHtml::listData(UnidadOrganizacional::model()->findAll(), 'id', 'nombre')); ?>		</div>
	</div>
