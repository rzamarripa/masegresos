<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<div class="clearfix">
		<?php echo $form->label($model,'requisicionTemp_did'); ?>
		<div class="input">
			
			<?php echo $form->dropDownList($model,"requisicionTemp_did",CHtml::listData(RequisicionTemp::model()->findAll(), 'id', 'nombre')); ?>		</div>
	</div>
	...
	<div class="clearfix">
		...
		<div class="input">
			...
			<?php echo $form->textField($model,'articulo',array('size'=>60,'maxlength'=>100)); ?>
		</div>
	</div>
